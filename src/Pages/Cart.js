...
Корзина</h2>
      ...
      <div className="cart__bottom">
        <div className="cart__bottom-details">
          <span> <b>{totalCount} шт.</b> </span>
  <span> Сумма заказа: <b>{totalPrice} BTC</b> </span>
        </div>
...
<Link to="/"  className="button--black">
      ...
      <p>
        Вероятней всего, вы не заказывали свою безумную бочку.<br />
        Для того, чтобы заказать одну-две, перейди на главную страницу.
      </p>
